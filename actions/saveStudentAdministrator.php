...
$q=mysql_query("select sf_code from center where center_code=".$_POST['depcode']);
...
$sql="insert into student_details(sl,dept_center_code,dept_center_course_code,semester_code,year_of_admission,student_name,registration_no,
	roll_no,fathers_name,mothers_name,dob,sex,community,region,fee_category,mb_no,fee_paid_upto_semester_code,email_id,student_id, stype,password,belongs_to_center_dept,created_by_id)
values($primary,'$dp','$scourse','$syear','$syoa','$sname','$sdureg','$sroll','$sfaname','$smoname','$sdob','$ssex','$scommunity','$sregion','$sfeecat','$smob','$sfee','$semail',
	'$studentcode', '$stype','$passcode','$bt','$creatorid')";
$result=mysql_query($sql) or die ("ERROR: $sql. " .mysql_error());
 ...
 header("Location:".$base."administratorCenterStudentEntry.php?response=$msg");
?>