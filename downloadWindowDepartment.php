...
<head>
  ...
  <?php if($type=='admin'){?>
  <title>DU | Downloads Manager</title>
  <?php } else {?>
  <title>Downloads | <?php echo $_SESSION['sessdeptname'];?></title>
  <?php } ?>
  <!-- Bootstrap core CSS -->
...
<?php if($type=='admin'){ require("includes/downloadWindow.php"); } else {

  require("includes/downloadWindowDepartment.php");
}?>
</div>
