...
<head>
 ...
 <?php require("includes/logincheck.php");?>
  ...
  <?php if($type=='admin'){?>
  <title>DU | Fee Structure Legend</title>
  <?php } else {?>
  <title>Fee Structure Legend | <?php echo $_SESSION['sessdeptname'];?></title>
  <?php } ?>
  <!-- Bootstrap core CSS -->
...
<?php if($type=='admin'){ require("fee/feeManageGetStartedAdminFilter.php"); } else {


if($_SESSION['branch_type']=='dept'){require("fee/feeManageGetStarted.php");}

  else {
require("fee/feeManageGetStarted.php");
