<?php ob_start(); require("includes/config.php"); error_reporting(E_ALL ^ E_NOTICE);
...
define('BACKUP_DIR', 'backupDumps' ) ; 
// Define  Database Credentials
define('HOST', 'localhost' ) ; 
define('USER', 'zantrikc_dudemo' ) ; 
define('PASSWORD', 'dudemo' ) ; 
define('DB_NAME', 'zantrikc_dudemo' ) ; 
/*
...
readfile(BACKUP_DIR . "/". $fileName . '.zip');
 
 

//header("Location:".$base."dashboard.php?response=".base64_encode($message));
exit();
