...
<head>
 ...
 <?php require("includes/logincheck.php");?>
  ...
  <?php if($type=='admin'){?>
  <title>DU | Course Manager</title>
  <?php } else {?>
  <title>Course Manager | <?php echo $_SESSION['sessdeptname'];?></title>
  <?php } ?>
  <!-- Bootstrap core CSS -->
...
<?php if($type=='admin'){ require("includes/courseGetStarted.php"); } else {


if($_SESSION['branch_type']=='dept'){require("includes/courseGetStartedLogger.php");}

  else {
require("includes/centerCourseGetStartedLogger.php");
