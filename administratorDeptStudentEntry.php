...
<head>
  ...
  <?php if($type=='admin'){?>
  <title>DU | Department Student Entry</title>
  <?php } else {?>
  <title>Student Entry | <?php echo $_SESSION['sessdeptname'];?></title>
  <?php } ?>
  <!-- Bootstrap core CSS -->
...
<?php if($type=='admin'){ require("includes/administratorDeptStudentEntry.php"); 
} else {

  require("includes/studentEntryStarted.php");
}?>
</div>
