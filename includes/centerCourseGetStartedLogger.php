...
<?php } ?>
      ...
      <form name="course" class="form-horizontal" action="<?php echo $base;?>actions/saveCenterCourseLogger.php" method="post">
                                        ...
                                        <legend><i class="fa fa-plus"></i> New Center-Course &raquo;
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                    ...
                                                    <select readonly title="Center" name="dept" id ="dept" class="form-control" required="true" >
                                        
                                        <?php 
										
										$select= mysql_query("select * from center where center_code=$deptcode order by center_code desc");
                                        ...
                                        <div class="modal-dialog" style='width:900px; height:450px;'>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                  ...
                                                  <form action="<?php echo $base;?>actions/editCenterCourseLogger.php
