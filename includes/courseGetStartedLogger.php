...
<?php } ?>
      ...
      <form name="course" class="form-horizontal" action="<?php echo $base;?>actions/saveCourseLogger.php" method="post">
         
                                    <fieldset>
                                        <legend><i class="fa fa-plus"></i> New Course &raquo; 
                                          <small style="color:darkgrey; font-weight:bold; font-size:11px"> 
                                            Use the below panel to add a new course in <?php echo $loggername;?></small></legend>
                                         <div class="form-group">
                                            <label style="color:red" class="col-lg-2 control-label" for="select02">Department*</label>
                                            <div class="col-lg-5">
                                               
                                                    <select readonly title="Department" name="dept" id ="dept" class="form-control" required="true" >
                                       
                                        <?php 
										
										$select= mysql_query("select * from department where dept_code=$deptcode");
										...
										?>
                                      <option selected value="<?php echo $rows['dept_code']; ?>"><?php echo $rows['dept_name']; ?></option>
                                      <?php 
									  		   }
										}
									  ?>
...
<span class="label label-primary"><i class="fa fa-info"></i> The following table shows department names with courses listed under <?php echo $loggername;?></span>
<br/><br/> 
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#del_<?php echo $fetchcourse['course_id'];?>").click(function(){
      ...
      $("#<?php echo $fetchcourse['course_id'];?>").hide(); 
   ...
   beforeSend: function() {
          ...
          success: function(data) {
            if(data.message=='Done' && data.num>=1){
             ...
             window.location.href="<?php echo $base;?>courseLoggerGetStarted.php";
...
<a href="#editer_<?php echo $fetchcourse['course_id'];?>" data-toggle="modal">
  <i  id="<?php echo $fetchcourse['course_id'];?>" title="Edit  <?php echo $fetchcourse['course_name'];?> under <?php echo $fetch['dept_name'];?>" class="fa fa-pencil pull-right"></i></a></li>
                                        ...
                                        <div class="modal-dialog" style='width:900px; height:450px;'>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                  ...
                                                  <form action="<?php echo $base;?>actions/editCourseLogger.php?id=<?php echo $fetchcourse['course_id'];?>" method="post">
