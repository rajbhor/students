...
<div class="page-head">
      <h3 title="Student Entry Panel" class="label label-success" style="font-size:19px">
        <i class="fa  fa-plus"></i> Center Student Entry Panel &raquo; <small style="color:black;font-size:12px">Use the below panel to make a student entry as <?php echo $loggername;?></small></h3>
    <br/><br/>  
...
<form name="student" id="student" action="<?php echo $base;?>actions/saveStudentAdministrator.php" method="post">
...
<div class="col-md-6 form-group">
						...
						<div >
						  <label for="title" style="color:red">Center:</label>
						...
						<div > 
						   ...
						   <?php
						    ...
						    $c=mysql_query("select * from center order by center_name desc");
						     
						     while($rc=mysql_fetch_array($c))
							 {
							 ?>
						    <option value="<?php echo $rc['center_code']; ?>">
						    <?php  echo $rc['center_name'];?>
						    </option>
						    <?php 
							 } 
						    ?>
...
var cenid=$(this).val();
var sel=$.trim($("#scourse").val());
var dataString = {'cenid': cenid,'sel':sel};
if(cenid!=''){
$.ajax
({
type: "POST",
url: "<?php echo $base;?>includes/getCenterCoursesAdministrator.php",
data: dataString,
 cache: false,
