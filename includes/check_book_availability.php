...
style="font-family:Segoe UI; font-weight:bold; font-size:15px">
	<thead>
		<tr>
...
<br/><a href="<?php echo $site;?>/issue/issueBook/<?php echo $acc;?>/<?php echo $mid;?>"><span title="Issue this book to <?php echo $m['member_name'];?>(<?php echo $m['id'];?>)" id='iss' class='btn btn-success' style='float:left'><i class="fa fa-mail-reply-all"></i> ISSUE BOOK</span></a>
...
style="font-family:Segoe UI; font-weight:bold; font-size:12px;min-width:330%">
	<thead>
		<tr>
