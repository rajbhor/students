...
$("#sc").fadeOut(10000);
  ...
  <div class="cl-mcont">
      <div class="page-head">
      <h3 title="Search Department" class="label label-success" style="font-size:19px">
        <i class="fa  fa-tasks"></i> Search Departments</h3>
      </div> 
...
<?php } ?>
      ...
      <form style="display:none" name="department" class="form-horizontal" action="<?php echo $base;?>actions/saveDepartment.php" method="post">
...
$i++; } ?>
  ...
  echo "<span id='nope' class='label label-danger'>No records exist. Please add a new department to reflect changes!!</span>";
