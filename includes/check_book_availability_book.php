...
$acc=$_POST['acc'];
$mid=$_POST['mid'];
$main=mysql_query("select * from members where id='$mid'");
if(mysql_num_rows($main)==1){
...
<td  style="color:#4B088A" align="center"><?php if($fetch['availability']=='available' || $fetch['availability']=='Available' || $fetch['availability']=='AVAILABLE' ){ 
	echo "<span title='This book is currently available and can be issued' class='label label-success'>Available</span>"; } 
else { //issued
echo "<span title='This book is currently unavailable' class='label label-danger'><i class='glyphicon glyphicon-ok'></i> Issued</span>";
...
<br/><a href="<?php echo $site;?>/issue/issueBookProfileBook/<?php echo $acc;?>/<?php echo $mid;?>"><span title="Issue this book to <?php echo $m['member_name'];?>(<?php echo $m['id'];?>)" id='iss' class='btn btn-success' style='float:left'><i class="fa fa-mail-reply-all"></i> ISSUE BOOK</span></a>
...
<td  style="color:#4B088A" align="center"><?php if($infor['availability']=='available' || $infor['availability']=='Available' || $infor['availability']=='AVAILABLE'){ 
	echo "<span title='This book is currently available and can be issued' class='label label-success'>Available</span>"; } 
...
echo "<br/>";
	echo "<span id='nope' class='label label-danger' style='float:left'><i class='fa fa-warning'></i> Sorry,but the member code that you provided is invalid. Please check and try again with a different member code!!</span>";
