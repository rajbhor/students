...
<?php } ?>
      ...
      <form name="course" class="form-horizontal" action="<?php echo $base;?>actions/saveCenterCourse.php" method="post">
...
<span style="display:none" class="label label-primary"><i class="fa fa-info"></i> The following table shows center names with courses listed under 
  each center</span>
<br/><br/> 
...
$i++; } ?>
  ...
  echo "<span id='nope' class='label label-danger' style='display:none'>No records exist. Please add a new course to reflect changes!!</span>";
