...
$("#sc").fadeOut(10000);
  ...
  <div class="cl-mcont">
      <div class="page-head">
      <h3 title="Search Center" class="label label-success" style="font-size:19px">
        <i class="fa  fa-random"></i> Search Centers</h3>
      </div> 
...
<?php } ?>
      ...
      <form style="display:none" name="department" class="form-horizontal" action="<?php echo $base;?>actions/saveCenter.php" method="post">
                                        ...
                                        <div class="modal-dialog" style='width:900px; height:450px;'>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                  ...
                                                  <form action="<?php echo $base;?>actions/editCenter.php
                                                    ?id=<?php echo $fetch['center_code'];?>" method="post">
...
$i++; } ?>
  ...
  echo "<span id='nope' class='label label-danger'>No records exist. Please add a new center to reflect changes!!</span>";
