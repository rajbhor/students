...
<div class="page-head">
      <h3 title="Search Department Operators" class="label label-success" style="font-size:19px">
        <i class="fa  fa-search"></i> Search Department Operators</h3>
      </div>
             
          <form style="display:none" name="course" class="form-horizontal" action="<?php echo $base;?>actions/saveUser.php" method="post">
                                         ...
                                         <div class="form-group" id="department" style="display:none">
                                            ...
                                            <div class="col-lg-5" >
                                               <input type="hidden" value="dept" name="flag" id="dflag" disabled>
                                                    <select title="Select a department to assign" disabled required name="dept" id ="dept" class="form-control" >
 ...
 <div class="form-group" id="centers" style="display:none">
                                            ...
                                            <div class="col-lg-5" >
                                              <input type="hidden" value="center" name="flag" id="cflag" disabled>  
                                                    <select title="Select a center to assign" style="color:black" disabled required name="dept" id ="center" 
                                                    class="form-control" >
