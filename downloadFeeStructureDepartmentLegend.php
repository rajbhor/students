...
$F->setCellValue('B1', 'DEPARTMENT');
	...
	$sql="SELECT * from  fee_structure where type='$bt'";	
...
if($bt=='dept') {
$filename="DU All Departments Fee Structure Information-".time().".xls";
}
else {
$filename="DU All Centers Fee Structure Information-".time().".xls";
