...
try{ 
		...
		// echo "UPDATE student_details SET student_name='$student_name', mb_no='$phn_no',email_id = '$email_id',sex = '$sex', dob = '$result' , fathers_name = '$fathername', mothers_name = '$mothername' WHERE student_id='$myname'";
		// exit();
		$query1 = mysql_query("UPDATE student_details SET student_name='$student_name', mb_no='$phn_no',email_id = '$email_id',sex = '$sex', dob = '$result' , fathers_name = '$fathername', mothers_name = '$mothername' WHERE student_id='$myname'");
