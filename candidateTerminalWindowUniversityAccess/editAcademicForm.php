...
<script type="text/javascript"> 
    function validateAcademicEditform()
    {
        
        var lastuniname,lastunireg,s2_8 = true;
        lastuniname = $("#lastuniname").val();

        lastunireg = $("#lastunireg").val();
        s2_8 = $("#s2_8").val();

        if(($.trim(lastuniname) == '')||($.trim(lastuniname) == 'Not Available'))
        {
            $("#lastuniname").focus();
            $("#lastunierror").show();
        ...
        {
            if(($.trim(lastunireg) == '')||($.trim(lastunireg) == 'Not Available'))
            {
                $("#lastunireg").focus();
                $("#lastuniregerror").show();
                $("#lastunierror").hide();
            }
            else
            {
                ...
                {
                    $("#s2_8").focus();
                    $("#presentcourseerror").show();
                    $("#lastuniregerror").hide();
                    $("#lastunierror").hide();
                }
                else
                {
                    $("#editAcademicform").submit();
                }
...
<form method="post" action="<?php echo $bases;?>actions/processAcademicEditProfile.php" id="editAcademicform" name="editAcademicform">
                    <div class="span9">                                        
                    <div class="block-fluid without-head">                        
                        <div class="toolbar clearfix">
                        <div class="toolbar clear clearfix">
                        <div class="centre">                                
                            <button type="button" class="btn btn-small btn-warning tip" onclick="showAcademic()">Edit Academic details<span class="icon-ok icon-white"></span></button>                                
                        </div>
                        </div>
                        ...
                        { ?>
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><input type="text"  id="lastuniname" name="lastuniname" value="<?php echo $defaultstr; ?>" />
                                <span style="display:none" id="lastunierror" class="required">This is required</span></div>
                            </div>
                        ...
                        { ?>
                            <div class="row-form clearfix">
                                <div class="span3">Last registered University</div>
                                <div class="span9"><input type="text"  id="lastuniname" name="lastuniname" value="<?php echo $last_uni_name; ?>"/>
                                <span style="display:none" id="lastunierror" class="required">This is required</span></div>
                            </div> 
                        <?php }
                        ...
                        { ?>
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><input type="text"  id="lastunireg" name="lastunireg" value="<?php echo $defaultstr; ?>"/>
                                <span style="display:none" id="lastuniregerror" class="required">This is required</span></div>
                            </div>
                        <?php }
                        else
                        { ?>
                            <div class="row-form clearfix">
                                <div class="span3">Last registered University Registration No</div>
                                <div class="span9"><input type="text"  id="lastunireg" name="lastunireg" value="<?php echo $last_uni_regno; ?>"/>
                                <span style="display:none" id="lastuniregerror" class="required">This is required</span></div>
                            </div>
                        <?php }
                        ?>
                        ...
                        <div class="row-form clearfix">
                            <table border="1px" width="100%" id="dataTable">
                                ...
                                <td>
                                    ...
                                    { ?>
                                        <input type="text" name="board10" id="board10" value="<?php echo $defstr; ?>" >
                                    <?php }
                                    else
                                    { ?>
                                        <input type="text" name="board10" id="board10" value="<?php echo $board_10;?>"  >
                                    <?php } ?>
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="roll10" id="roll10" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="roll10" id="roll10" value="<?php echo $board_10_roll; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                    <?php 
                                    ...
                                    { ?>
                                        <input type="text" name="yop10" id="yop10" value="<?php echo $defstr; ?>"  >
                                    <?php }
                                    else
                                    { ?>
                                        <input type="text" name="yop10" id="yop10" value="<?php echo $board_10_yop; ?>"  >
                                    <?php } ?>
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="div10" id="div10" value="<?php echo $defstr; ?>" >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="div10" id="div10" value="<?php echo $board_10_div; ?>" >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="percent10" id="percent10" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="percent10" id="percent10" value="<?php echo $board_10_percent; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="sub10" id="sub10" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="sub10" id="sub10" value="<?php echo $board_10_sub; ?>"  >
                                <?php } ?>
                                </td>
                                </tr>
                                <tr>
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="board10_2" id="board10_2" value="<?php echo $defstr; ?>" >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="board10_2" id="board10_2" value="<?php echo $board10_2; ?>" >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="roll10_2" id="roll10_2" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="roll10_2" id="roll10_2" value="<?php echo $board10_2_roll; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="yop10_2" id="yop10_2" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="yop10_2" id="yop10_2" value="<?php echo $board10_2_yop; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="div10_2" id="div10_2" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="div10_2" id="div10_2" value="<?php echo $board10_2_div; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                    <?php 
                                    ...
                                    { ?>
                                        <input type="text" name="percent10_2" id="percent10_2" value="<?php echo $defstr; ?>"  >
                                    <?php }
                                    else
                                    { ?>
                                        <input type="text" name="percent10_2" id="percent10_2" value="<?php echo $board10_2_percent; ?>"  >
                                    <?php } ?>
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="sub10_2" id="sub10_2" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="sub10_2" id="sub10_2" value="<?php echo $board10_2_sub; ?>"  >
                                <?php } ?>
                                </td>
                                </tr>
                                <tr>
                                ...
                                { ?>
                                    <input type="text" name="board10_2_3" id="board10_2_3" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="board10_2_3" id="board10_2_3" value="<?php echo $board10_2_3; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="roll10_2_3" id="roll10_2_3" value="<?php echo $defstr; ?> " >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="roll10_2_3" id="roll10_2_3" value="<?php echo $board10_2_3_roll; ?> " >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="yop10_2_3" id="yop10_2_3" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="yop10_2_3" id="yop10_2_3" value="<?php echo $board10_2_3_yop; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="percent10_2_3" id="percent10_2_3" value="<?php echo $defstr; ?>"  >
                                <?php } 
                                else
                                { ?>
                                    <input type="text" name="percent10_2_3" id="percent10_2_3" value="<?php echo $board10_2_3_percent; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="sub10_2_3" id="sub10_2_3" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="sub10_2_3" id="sub10_2_3" value="<?php echo $board10_2_3_sub; ?>"  >
                                <?php } ?>
                                </td>
                                </tr>
                                <!--<tr>
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="examextra" id="examextra" value="<?php echo $defstr ; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="examextra" id="examextra" value="<?php echo $examextra ; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="boardexamextra" id="boardexamextra" value="<?php echo $defstr; ?>"  >
                                <?php } 
                                else
                                { ?>
                                    <input type="text" name="boardexamextra" id="boardexamextra" value="<?php echo $boardexamextra; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="rollexamextra" id="rollexamextra" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="rollexamextra" id="rollexamextra" value="<?php echo $rollexamextra; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="yopexamextra" id="yopexamextra" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="yopexamextra" id="yopexamextra" value="<?php echo $yopexamextra; ?>"  >
                                 <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="divexamextra" id="divexamextra" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="divexamextra" id="divexamextra" value="<?php echo $divexamextra; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="percentexamextra" id="percentexamextra" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="percentexamextra" id="percentexamextra" value="<?php echo $percentexamextra; ?>"  >
                                <?php } ?>
                                </td>
                                <td>
                                <?php 
                                ...
                                { ?>
                                    ...
                                    <input type="text" name="subexamextra" id="subexamextra" value="<?php echo $defstr; ?>"  >
                                <?php }
                                else
                                { ?>
                                    <input type="text" name="subexamextra" id="subexamextra" value="<?php echo $subexamextra; ?>"  >
                                <?php } ?>
                                </td>
                                </tr>
                            </table>
                        ...
                        { ?>
                            <div class="row-form clearfix">
                                <div class="span3"><pre>Are you undergoing any course of study at present?:</pre></div>
                                <div class="span9">
                                    <select name="select8" id="s2_8" style="width: 100%;" onchange="showTextbox1()">
                                     ...
                                     <span style="display:none" id="presentcourseerror" class="required">Select one</span> 
                                </div>
                            </div>

                            <div class="row-form clearfix" id="texthide1" style="display:">
                                <div class="span3">Give Details</div>
                                <div class="span9"><textarea id="texthide1" name="texthide1"><?php echo $undergoing_course_details; ?></textarea><span style="display:none" id="presentcoursedetailserror" class="required">This is required</span></div>
                            </div>
                        <?php }
                        else
                        { ?>
                            ...
                            <div class="row-form clearfix" id="texthide1" style="display:none">
                                <div class="span3">Give Details</div>
                                <div class="span9"><textarea id="texthide1" name="texthide1"><?php echo $defaultstr; ?></textarea><span style="display:none" id="presentcoursedetailserror" class="required">This is required</span></div>
                            </div>
                        ...
                        <div class="toolbar clearfix">
                            ...
                            <div class="right">
                                <div class="btn-group">
                                        <button type="button" class="btn btn-small btn-warning tip" title="Quick save" onclick="return validateAcademicEditform()">Save</button>
