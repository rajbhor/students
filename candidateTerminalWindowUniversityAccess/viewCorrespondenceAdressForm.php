...
?>
<form method="post" action="<?php echo $bases;?>actions/processCorrespondenceEditProfile.php" id="editform" name="editform">
                <div class="span10">                                        
                    <div class="block-fluid without-head">                        
                        <div class="toolbar clearfix">    
                        <div class="toolbar clear clearfix">
                            <div class="centre">                                
                                <button type="button" class="btn btn-small btn-warning tip" onclick="showCorrespondence()">View Address for correspondence<span class="icon-ok icon-white"></span></button>                                
                            </div>
                        </div>
                    ...
                    <div class="toolbar clear clearfix">
                        ...
                        { ?>
                            <div class="row-form clearfix"> 
                                ...
                                <div class="span9"><textarea id="correspondenceAddress" name="correspondenceAddress"  readonly="true" ><?php echo $defaultstr;?></textarea><span style="display:none" id="error10" class="required">This is required</span></div>
                            </div> 
                        <?php }
                        else
                        { ?>
                             <div class="row-form clearfix"> 
                                ...
                                <div class="span3">Address</div>
                                <div class="span9"><textarea id="correspondenceAddress" name="correspondenceAddress"  readonly="true" ><?php echo $corr_address; ?></textarea><span style="display:none" id="error10" class="required">This is required</span></div>
                            </div>
                        <?php }
                        ...
                        { ?>
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><input type="text" id="correspondencepin" name="correspondencepin" value="<?php echo $defaultstr; ?>" readonly="true" /><span style="display:none" id="error11" class="required">This is required</span></div>
                            </div>   
                        <?php }
                        else
                        { ?>
                             ...
                             <div class="row-form clearfix">
                                <div class="span3">Pin</div>
                                <div class="span9"><input type="text" id="correspondencepin" name="correspondencepin" value="<?php echo $corr_pincode; ?>" readonly="true" /><span style="display:none" id="error11" class="required">This is required</span></div>
                            </div>  
                        <?php }
                        ...
                        {?>
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><input type="text" id="correspondencephone" name="correspondencephone" value="<?php echo $defaultstr; ?>" readonly="true"/><span style="display:none" id="error12" class="required">This is required</span></div>
                            </div>
                        <?php }
                        else
                        { ?>
                            ...
                            <div class="row-form clearfix">
                                <div class="span3">Phone no</div>
                                <div class="span9"><input type="text" id="correspondencephone" name="correspondencephone" value="<?php echo $corr_phone_no; ?>" readonly="true"/><span style="display:none" id="error12" class="required">This is required</span></div>
                            </div>
                        <?php }
                        ?>
